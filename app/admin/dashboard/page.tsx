  ...
  return (
    <ProtectedRoute>
      <div className="flex flex-col h-screen bg-gray-100">
        {/* Navbar */}
        <nav className="bg-gradient-to-r from-[#10203c] to-[#54709c] text-white p-4 shadow-lg flex justify-between">
            ...
            {["All", "pending", "dispatch", "success"].map((status) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-all ${
                  filter === status ? "bg-white text-[#10203c] font-bold" : "text-white"
                }`}
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="overflow-x-auto bg-white shadow-md rounded-lg">
            <table className="min-w-full divide-y divide-gray-200 text-sm lg:text-base">
              <thead className="bg-gradient-to-r from-[#10203c] to-[#54709c] text-white">
                <tr>
                  <th>ID</th>
                  <th>Customer</th>
                  <th>Address</th>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <button
                          ...
                          className="bg-[#10203c] text-white px-3 py-1 rounded hover:bg-[#10203c] transition"
                        >
                          Delete
                        </button>
                      </td>
